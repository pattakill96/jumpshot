<?php
  ...
  if(isset($_GET['error'])) {
    if($_GET['error'] == 1005)
      ...
      if(isset($_POST['nome']) && isset($_POST['cognome']) && isset($_POST['username']) && isset($_POST['password']) &&
        isset($_POST['indirizzo']) && isset($_POST['citta']) && isset($_POST['cap']) && isset($_POST['payment'])) {
        if(empty($_POST['nome']) || empty($_POST['cognome']) || empty($_POST['username']) || empty($_POST['payment']) ||
